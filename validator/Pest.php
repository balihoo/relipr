...
class Pest {
  ...
  public function post($url, $data, $headers=array()) {
    ...
    if (!is_array($data)) $headers[] = 'Content-Length: '.strlen($data);
		$existingHeaders = array_key_exists(CURLOPT_HTTPHEADER, $curl_opts) ? $curl_opts['CURLOPT_HTTPHEADER'] : array();
    $curl_opts[CURLOPT_HTTPHEADER] = array_merge($headers, $existingHeaders);
